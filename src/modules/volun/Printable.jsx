...
function Printable(props) {
  ...
  return <Document title={`${consultation.student.name} 님의 봉사활동 설계서`}>
    <Page size="A4" style={{
      padding: 30,
      fontFamily: "Pretendard",
      fontSize: 9,
    }}>
      <SectionTitle>봉사활동 설계서</SectionTitle>
      ...
      <View wrap={false}>
        ...
        <Card>
          ...
          <Body1>{activity.activityAbilities.length ? activity.activityAbilities.join(", ") : "작성된 내용이 없습니다"}</Body1>
        </Card>
      </View>
      <View style={{ height: 30 }} />
